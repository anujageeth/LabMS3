...
function UserDetails({ onUserDataFetched }) {
    ...
    const fetchUnreadCount = async () => {
        try {
            ...
            const response = await axios.get("http://10.50.227.93:3001/api/notifications/unread-count", {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const fetchNotifications = async () => {
        try {
            ...
            const response = await axios.get("http://10.50.227.93:3001/api/notifications", {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const markAsRead = async (id) => {
        try {
            ...
            await axios.put(`http://10.50.227.93:3001/api/notifications/${id}/read`, {}, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const markAllAsRead = async () => {
        try {
            ...
            await axios.put("http://10.50.227.93:3001/api/notifications/read-all", {}, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
